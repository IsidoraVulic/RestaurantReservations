...
public class GuestForm extends GenericForm {
    ...
    void setFormName() {
        if (status.equals("add")) {
            this.setTitle("Kreiranje novog gosta");
        } else if (status.equals("edit")) {
            this.setTitle("Izmena gosta");
        }
    }
    ...
    private void saveGuest() throws Exception {
        boolean success = Controller.getInstace().saveGuest(getFormData());
        HashMap<String, String> hashMapGuest = getFormData();
        if (success) {
            closeForm();
            JOptionPane.showMessageDialog(parentForm, "Sistem je zapamtio gosta: \nIme gosta: " + hashMapGuest.get("firstname")  + "\n Prezime: " + hashMapGuest.get("lastname")
                    + "\n Telefon: " + hashMapGuest.get("contact") + "\n Email: " + hashMapGuest.get("email"));
